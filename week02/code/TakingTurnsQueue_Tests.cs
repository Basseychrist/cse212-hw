...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue behaved like a stack (LIFO) instead of a queue (FIFO), causing
    // order mismatches (e.g., Sue appeared before Bob in early turns).
    ...
    // Defect(s) Found: Queue ordering defect (LIFO behavior) persisted when adding a new person
    // mid-run, producing incorrect turn order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Queue ordering defect (LIFO behavior) caused wrong sequence.
